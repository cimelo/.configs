...
#ssh
alias sa="ssh-add ${HOME}/.ssh/id_!(*.pub)"

# Create parent folder by default
alias mkdir='mkdir -p'
...
alias pip='/home/caio/python_packages/bin/pip'
...
alias ufpe="/mnt/general/UFPE/"

export QSYS_ROOTDIR="/home/caio/.cache/yay/quartus-free/pkg/quartus-free-quartus/opt/intelFPGA/23.1/quartus/sopc_builder/bin"
